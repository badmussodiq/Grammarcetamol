...
// Same internal-caller convention as enrollment-service's CourseServiceClient (Java) — never
// goes through the gateway, presents as a trusted SUPER_ADMIN caller since course-service has
// no concept of "this student is mid-checkout" to authorize against otherwise.
