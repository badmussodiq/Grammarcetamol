...
export default function AdminForgotPasswordPage() {
  ...
  async function handleSubmit(e: SubmitEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // the admin straight to the code-entry form instead of a static "check your inbox" dead
      // end, pre-filling the email they just typed.
  ...
  return (
    <>
      ...
      <p className="text-[#64748B] text-sm mb-6">Enter your admin email to receive a 6-digit reset code.</p>
